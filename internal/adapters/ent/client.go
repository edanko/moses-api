...
import (
	...
	nest2 "github.com/edanko/moses-api/internal/adapters/ent/nest"
	part2 "github.com/edanko/moses-api/internal/adapters/ent/part"
	remnant2 "github.com/edanko/moses-api/internal/adapters/ent/remnant"
)
...
func (c *NestClient) DeleteOneID(id uuid.UUID) *NestDeleteOne {
	builder := c.Delete().Where(nest2.ID(id))
...
func (c *NestClient) Get(ctx context.Context, id uuid.UUID) (*Nest, error) {
	return c.Query().Where(nest2.ID(id)).Only(ctx)
}
...
func (c *NestClient) QueryParts(n *Nest) *PartQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(nest2.Table, nest2.FieldID, id),
			sqlgraph.To(part2.Table, part2.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, false, nest2.PartsTable, nest2.PartsPrimaryKey...),
		)
...
func (c *NestClient) QueryRemnant(n *Nest) *RemnantQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(nest2.Table, nest2.FieldID, id),
			sqlgraph.To(remnant2.Table, remnant2.FieldID),
			sqlgraph.Edge(sqlgraph.O2O, false, nest2.RemnantTable, nest2.RemnantColumn),
		)
		fromV = sqlgraph.Neighbors(n.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *NestClient) QueryRemnantUsed(n *Nest) *RemnantQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(nest2.Table, nest2.FieldID, id),
			sqlgraph.To(remnant2.Table, remnant2.FieldID),
			sqlgraph.Edge(sqlgraph.M2O, true, nest2.RemnantUsedTable, nest2.RemnantUsedColumn),
		)
		fromV = sqlgraph.Neighbors(n.driver.Dialect(), step)
		return fromV, nil
	}
...
func (c *PartClient) DeleteOneID(id uuid.UUID) *PartDeleteOne {
	builder := c.Delete().Where(part2.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *PartClient) Get(ctx context.Context, id uuid.UUID) (*Part, error) {
	return c.Query().Where(part2.ID(id)).Only(ctx)
}
...
func (c *PartClient) QueryNests(pa *Part) *NestQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := pa.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(part2.Table, part2.FieldID, id),
			sqlgraph.To(nest2.Table, nest2.FieldID),
			sqlgraph.Edge(sqlgraph.M2M, true, part2.NestsTable, part2.NestsPrimaryKey...),
		)
...
func (c *RemnantClient) DeleteOneID(id uuid.UUID) *RemnantDeleteOne {
	builder := c.Delete().Where(remnant2.ID(id))
	builder.mutation.id = &id
	builder.mutation.op = OpDeleteOne
...
func (c *RemnantClient) Get(ctx context.Context, id uuid.UUID) (*Remnant, error) {
	return c.Query().Where(remnant2.ID(id)).Only(ctx)
}
...
func (c *RemnantClient) QueryNest(r *Remnant) *NestQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		id := r.ID
		step := sqlgraph.NewStep(
			sqlgraph.From(remnant2.Table, remnant2.FieldID, id),
			sqlgraph.To(nest2.Table, nest2.FieldID),
			sqlgraph.Edge(sqlgraph.O2O, true, remnant2.NestTable, remnant2.NestColumn),
		)
...
func (c *RemnantClient) QueryRemnantUsed(r *Remnant) *NestQuery {
	...
	query.path = func(ctx context.Context) (fromV *sql.Selector, _ error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(remnant2.Table, remnant2.FieldID, id),
			sqlgraph.To(nest2.Table, nest2.FieldID),
			sqlgraph.Edge(sqlgraph.O2M, false, remnant2.RemnantUsedTable, remnant2.RemnantUsedColumn),
		)
		fromV = sqlgraph.Neighbors(r.driver.Dialect(), step)
		return fromV, nil
	}
