...
import (
	...
	"github.com/edanko/moses-api/internal/adapters/ent/nest"
	"github.com/edanko/moses-api/internal/adapters/ent/part"
	"github.com/edanko/moses-api/internal/adapters/ent/remnant"
	schema2 "github.com/edanko/moses-api/internal/adapters/ent/schema"
)
...
func init() {
	...
	remnantMixin := schema2.Remnant{}.Mixin()
	...
	remnantFields := schema2.Remnant{}.Fields()
	_ = remnantFields
